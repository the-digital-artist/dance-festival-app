...
class AssetLoader {
    ...
    public loadAssets(imageList: Array<{ fileName, imgSrc }>) {
        try {
            ...
            console.log('trying to load: reinier_valdez'); imageList.push({ fileName:'reinier_valdez.png', imgSrc: require('../assets/portraits/reinier_valdez.png')} ); 
            ...
            console.log('trying to load: rna'); imageList.push({ fileName:'rna.png', imgSrc: require('../assets/portraits/rna.png')} ); 
